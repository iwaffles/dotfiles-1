# [Matt](https://github.com/iwaffles)’s dotfiles

[![Build Status](https://travis-ci.org/iwaffles/dotfiles.svg?branch=master)](https://travis-ci.org/iwaffles/dotfiles)
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/iwaffles/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/iwaffles/dotfiles/master/src/os/setup.sh)"` |
...
`setup` script](https://github.com/iwaffles/dotfiles/blob/1503cf23ef23f6e31342b140bcd246625160b94f/src/os/setup.sh#L3).
